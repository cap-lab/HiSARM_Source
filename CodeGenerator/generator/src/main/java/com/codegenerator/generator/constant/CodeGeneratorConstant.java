...
public class CodeGeneratorConstant {
    ...
    public static final String GROUPING_HEADER = "semo_group.h";
    ...
    public static final Path PORT_SOURCE_CODE = Paths.get(SOURCE_DIRECTORY.toString(), PORT_SOURCE);
    ...
    public static final Path GROUPING_HEADER_CODE =
            Paths.get(INCLUDE_DIRECTORY.toString(), GROUPING_HEADER);
